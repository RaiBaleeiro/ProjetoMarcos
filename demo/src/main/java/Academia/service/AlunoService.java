...
public class AlunoService {
   ...
   // public List<Aluno> listAll() {
    //    return List.of(new Aluno( 0L,"Paulo","50", "Basico"), new Aluno( 1L,"Joao","75", "intermediário"), new Aluno( 2L,"Sam","100", "Completo"));
   // }
    ...
    public void replace(AlunoPutRequestBody alunoPutRequestBody){
        ...
        Aluno aluno = Aluno.builder().id(alunoPutRequestBody.getId()).Nome(alunoPutRequestBody.getNome()).build();
